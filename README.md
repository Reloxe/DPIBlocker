...
- **Güvenli DNS**: Uygulamamızda sadece güvenilir dns sağlayıcıları kullanılır (cloudflare, adguarddns). Varsayılan goodbyedpi gibi programlarda kendinizde görebilirsinizki dns sunucuları farklı şeylerdir.
